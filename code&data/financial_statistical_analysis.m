...
x = 0:0.01:8;
y = chi2cdf(x, 3);
plot(x, y, 'k:', 'LineWidth', 3, color='b');
xlim([0 8]);
...
testx = lillietest(x) % 1 - not normal
testy1 = lillietest(y1) % 0 - normal

% Lilliefors test shows that y1 sample comes from a natural distribution
% We can confirm it by plotting it
...
% QQ plots confirm our earlier assumption
...
% stock prices at its closing time 
...
% Companies' stocks are positively correlated
...
% Literature is clear : Jarque-Bera test would be the best fit in this
% scenario. That's because it is very commonly used in financial data
% analysis
...
% AVGO has bigger p-value, hence we choose it
